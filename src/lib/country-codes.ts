// Comprehensive list of all countries with their dial codes and flags
...
export function extractCountryFromPhone(phone: string): {
	country: Country | undefined;
	localNumber: string;
} {
	if (!phone) return { country: undefined, localNumber: "" };
	...
	return { country: undefined, localNumber: cleanPhone.replace(/^\+/, "") };
}
