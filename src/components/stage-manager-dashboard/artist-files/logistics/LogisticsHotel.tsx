...
export function LogisticsHotel({ artist }: LogisticsHotelProps) {
    ...
    <div className="space-y-6">
      ...
      {(!hotels || hotels.length === 0) ? (
        ...
        <div className="space-y-4">
          {hotels.map((hotel) => (
            <div key={hotel.id} className="rounded-[28px] border border-slate-100 bg-white p-6 shadow-sm ring-1 ring-slate-50">
